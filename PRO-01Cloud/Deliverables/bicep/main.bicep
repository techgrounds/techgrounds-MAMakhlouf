...
resource azurerm_virtual_network vnet1 '2022-03-01' = {
  name: 'vnet1'
  location: location
  addressSpace: {
    addressPrefixes: [
...
resource azurerm_subnet subnet1 '2022-03-01' = {
  name: 'subnet1'
  parent: vnet1
  addressPrefix: '10.0.0.0/24'
}

resource azurerm_availability_set availabilitySet1 '2022-03-01' = {
